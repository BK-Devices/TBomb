...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/BK-Devices/TBomb/archive/dev.zip"
        dir_name = "TBomb-dev"
    else:
        zip_url = "https://github.com/BK-Devices/TBomb/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/BK-Devices/TBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/BK-Devices/TBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/BK-Devices/TBomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/BK-Devices/TBomb/raw/dev/.notify"
        else:
            url = "https://github.com/Bk-Devices/TBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by BK_devices")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 500, "call": 30, "mail": 200}
        cc, target = "", ""
        if mode in ["sms", "call"]:
